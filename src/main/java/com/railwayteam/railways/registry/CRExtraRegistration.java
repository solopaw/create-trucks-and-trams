...
import com.simibubi.create.content.redstone.displayLink.target.DisplayBoardTarget;
 ...
 public class CRExtraRegistration {
     ...
     public static void addSignalSource() {
         ...
         DisplayBoardTarget signalDisplaySource = AllDisplayTargets.register(Create.asResource("track_signal_source"), new SignalDisplaySource());
         AllDisplayTargets.register();
        //  .assignBlock(signalDisplaySource, Create.asResource("track_signal"));
