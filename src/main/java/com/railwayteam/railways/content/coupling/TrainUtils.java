     ...
     public static void tryToParkNearby(Train train, double maxDistance) {
         {
             ...
             double distance = discoveryPoint.travel(train.graph, maxDistance+offsetDist, discoveryPoint.steer(TravellingPoint.SteerDirection.NONE, new Vec3(0, 1, 0)), (a, couple) -> {
